  ...
  useEffect(() => {
    if (image && canvasRef.current) {
      ...
      img.onload = () => {
        ...
        const maxWidth = 500; // Reduced from unconstrained
        const maxHeight = 300; // New constraint
        let width = img.width;
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
            ...
            <Box sx={{ display: 'flex', gap: 1, alignItems: 'center' }}>
              <TextField
                ...
                sx={{
                  ...
                  '& .MuiInputBase-input': { color: colorScheme.text, fontSize: '12px' },
                  '& .MuiInputLabel-root': { color: colorScheme.secondaryText, fontSize: '14px' },
            ...
            <Grid container spacing={1} sx={{ flexWrap: 'wrap' }}>
              <Grid item xs={6} sm={4}>
                <FormControl size="small" fullWidth>
                  <InputLabel sx={{ color: colorScheme.secondaryText, fontSize: '14px', '&.Mui-focused': { color: colorScheme.primary } }}>
                    Font
                  </InputLabel>
                  <Select
              ...
              <Grid item xs={6} sm={4}>
                <FormControl size="small" fullWidth>
                  ...
                  <Select
                    value={activeText?.styles.fontSize || 20}
              ...
              <Grid item xs={6} sm={4}>
                <TextField
                  ...
                  sx={{
                    ...
                    '& .MuiInputBase-input': { color: colorScheme.text, padding: '4px', fontSize: '12px' },
                    '& .MuiInputLabel-root': { color: colorScheme.secondaryText, fontSize: '14px' },
                    '& .MuiInputLabel-root.Mui-focused': { color: colorScheme.primary },
                  }}
                />
          ...
          >
            {image ? (
              ...
              <Typography
                variant="body2"
                sx={{ color: colorScheme.secondaryText, textAlign: 'center', py: 2, fontSize: '12px' }}
              >
